...
class CabineProduct extends StatelessWidget {
  @override
        ...
        builder: (_, productManager, __) {
          return ListView.builder(
              ...
              itemBuilder: (context, index) {
                if (productManager.allProducts[index].category == 'cabine') {
                  return Column(
                    children: <Widget>[
                      ProductTile(productManager.allProducts[index])
                    ],
                  );
                } else {
                  return Container();
